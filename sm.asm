...
.data    
  ...
  platformsX dw 10,60,40,70,50,90,20,80,100,140,120,190,'#','#'
  platformsY dw 170,180,190,194,20,30,50,60,60,70,130,140,'#','#'
  platformExist db 1,1,1,1,1,1
...
call getMousePositionAndStatusPlyer2                                           
mov ax,player2mouseStatus
mov cx,ax
